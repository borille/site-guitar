...
/**
 * Classe Db table que acessa a tabela SIRH.SIRH_TB002_LOTACAO_My
 *
 * @category    My
 * @package     My_Db_Table
 * @subpackage  Sirh
 * @name        My_Db_Table_Sirh_Lotacao
 * @copyright   Copyright (c) 2013 - My
 * @version     1.0
 */

class My_Db_Table_Sirh_Lotacao extends My_Db_Table_Sirh
{

	public function init()
	{
		parent::configDbTable( 'SIRH', 'SIRH_TB002_LOTACAO_My', 'SIRH_TB002_VERBA' );
	}
	...
	public function getLotacaoCompleta( $verba = null, $ativas = true )
	{
		...
		$select->from( array( 'LOTACAO' => 'SIRH_TB002_LOTACAO_My' ) )
