 ...
 * @category    My
 * @package     My_Model
 * @name        My_Model_DbTable
 * @copyright   Copyright (c) 2012 - My
 * @author      TRB
 * @version     1.0
 * 
 */
abstract class My_Model_DbTable extends Zend_Db_Table_Abstract
{
     ...
     */
    public function save( My_Model_Model $model, $useTransaction = true, $profiler = true )
    {
        try
        {
            //verifica se o objeto é filho da classe My_Model_Model
            if ( get_parent_class( $model ) != 'My_Model_Model' )
            {
