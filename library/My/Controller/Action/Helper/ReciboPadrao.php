...
class My_Controller_Action_Helper_ReciboPadrao extends Zend_Controller_Action_Helper_Abstract
{
    ...
    {   
        ...
        $logo = $_SERVER['DOCUMENT_ROOT'] . "/Geral/imagens/My2.gif";
...
<tr>
    ...
    <th colspan='2'>
        <br>
        My - URBANIZAÇÃO DE CURITIBA S.A.<br>
...
<tr>    
    <td>&nbsp;</td>
    <td><strong>PAGÁVEL SOMENTE NOS CAIXAS DA TESOURARIA DA My</strong></td>
    <td>&nbsp;</td>
</tr>
<tr>
