...
class My_Controller_Action_Helper_Recibo extends Zend_Controller_Action_Helper_Abstract
{

    /**
     * @param My_Pdf_MyZendPdf $pdf Objeto ao qual será adicionado o recibo
     * @param type $nome Nome
     * @param type $valor Valor
     * @param type $text Descrição do Recibo
     * @return My_Pdf_MyZendPdf Retorna o próprio objeto passado
     */
    public function direct( My_Pdf_MyZendPdf $pdf, $nome = null, $valor = null, $text = null )
    {
        //cria uma pagina        
        ...
        for ( $i = 0; $i < 3; $i++ )
        {
            ...
            $pdf->drawText( $page, 'My - URBANIZAÇÃO DE CURITIBA S.A.', $marginLeft + 80, $marginTop - 20, $marginRight, TEXT_ALIGN_CENTER );
            ...
            $pdf->drawText( $page, 'ATX-UGX', $marginLeft, $marginTop - 95, $marginLeft + 80, TEXT_ALIGN_CENTER );
            ...
            $pdf->drawText( $page, 'PAGÁVEL SOMENTE NOS CAIXAS DA TESOURARIA DA My', $marginLeft + 85, $marginTop - 165, $marginLeft + 80, TEXT_ALIGN_LEFT );
