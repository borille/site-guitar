 ...
 * @package     My_Model
 * @subpackage  Conscf
 * @name        My_Model_Conscf_Empresa
 * @copyright   Copyright (c) 2013 - My
 * @version     1.0
 */

//TODO: renomear os getters/setters
class My_Model_Conscf_Empresa extends My_Model_Abstract
{
	protected $TB0200_EMPRESA;
	...
	public function setTB0200EMPRESA( $TB0200_EMPRESA )
	{
		$this->TB0200_EMPRESA = $TB0200_EMPRESA;
		return $this;
	}

	public function getTB0200EMPRESA()
	{
		return $this->TB0200_EMPRESA;
	}
